...
<html lang="en">
<head>
	<title>Masuk || Toko Pemesanan Vaccum Cooler</title>
	<meta charset="UTF-8">
...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('gambar/cyber.gif');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="login100-form-avatar">
						<img src="template/masuk/images/vaccumcooler.png" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-20 p-b-45">
						Selamat Datang Di Toko Pemesanan Vaccum Cooler
					</span>
					...
					<div class="container-login100-form-btn p-t-10">
						<button style="background: linear-gradient(to right, blue, purple);" type="submit" name="login" class="login100-form-btn">
							Login
						</button>
					</div>
					<?php
					...
					<br><br><br><br><br>
					<div class="text-center w-full">
						<p class="txt1">Belum punya akun? Silahkan daftar</p>
						<a class="btn btn-secondary" href="daftar.php">
							Create new account
							<i class="fa fa-long-arrow-right"></i>
						</a>
					</div>
